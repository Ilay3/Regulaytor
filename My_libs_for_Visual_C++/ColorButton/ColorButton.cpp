...
void CColorButton::DrawButtonText(CDC *DC, CRect R, const TCHAR *Buf, COLORREF TextColor)
{
...
COLORREF CColorButton::GetFGColor()			{ return m_fg; }	
COLORREF CColorButton::GetBGColor()			{ return m_bg; }
COLORREF CColorButton::GetDisabledColor()	{ return m_disabled; }
UINT	 CColorButton::GetBevel()			{ return m_bevel; }
		
//выставляет цвет текста на кнопке
void CColorButton::SetFGColor(const COLORREF fgcolor)
{
	m_fg=fgcolor;
	Invalidate();
}
//выставляет цвет кнопки
void CColorButton::SetBGColor(const COLORREF bgcolor)
{
	m_bg=bgcolor;
	Invalidate();
}
//выставляет цвет кнопки в неактивном состоянии
void CColorButton::SetDisabledColor(const COLORREF disabledcolor)
{
	m_disabled=disabledcolor;
	Invalidate();
}
//установить скос
void CColorButton::SetBevel(UINT bevel)
{
	m_bevel = bevel;
	Invalidate();
}
