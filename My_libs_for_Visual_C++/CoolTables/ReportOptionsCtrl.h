...
public:
	...
	virtual UINT GetWindowStyle() { return WS_VISIBLE|WS_CHILD|ES_LEFT|ES_AUTOHSCROLL; };
	virtual UINT GetWidth() { return 100; };
...
public:
	...
	virtual UINT GetWindowStyle() { return WS_CHILD|WS_VISIBLE|WS_VSCROLL|CBS_DROPDOWNLIST; };
	virtual UINT GetWidth() { return 100; };
	virtual UINT GetHeight() { return 100; };
