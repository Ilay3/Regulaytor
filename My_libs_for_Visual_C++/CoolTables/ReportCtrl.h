...
// Column Format
#define RVCF_LEFT				0x1<<0		//HDF_LEFT
#define RVCF_RIGHT				0x1<<1		//HDF_RIGHT
#define RVCF_CENTER				0x1<<2		//HDF_CENTER
#define RVCF_TEXT				0x1<<3		//HDF_STRING
#define RVCF_IMAGE				0x1<<4		//HDF_IMAGE
#define RVCF_SINGLELINE			0x1<<6		//МОЁ не учитывать переносы
#define RVCF_VCENTER			0x1<<7		//МОЁ вертикальное выравнивание по центру

#define	RVCF_JUSTIFYMASK		0x000000ff	//HDF_JUSTIFYMASK
