...
*		11.09.2006 - Теперь при отключенном файле ПС не создается соответствующей переменной настройки
*******************************************************************************************************/
...
public:
	...
	bool            o_LogInByteStuffing1;	//нужно ли фиксировать байт-стаффинг на приеме
	...
	afx_msg void OnBnClickedLogBsIn();
